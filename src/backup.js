...
export const STORE_KEYS = ['saved', 'checks', 'expenses', 'meals', 'shoppingItems', 'days', 'visits', 'meteo', 'trajets', 'trajetSteps', 'trip', 'logi', 'courses', 'budgetTotal', 'hebergement', 'trajetCheckItems', 'suggestions', 'lastBackupAt', 'journal', 'carGames', 'photos', 'familyMembers', 'bingo', 'lastSeenBuild', 'restos', 'departure', 'ratings', 'challengesDone', 'carSpot', 'features']
