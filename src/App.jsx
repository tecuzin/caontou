  ...
  return (
    <main data-testid="app-root" style={{
      ...
      <Navigation
        ...
        days={days} deleteActivity={deleteActivity} deleteCourseCategory={deleteCourseCategory} deleteCourseItem={deleteCourseItem} deleteExpense={deleteExpense} deleteLogiItem={deleteLogiItem}
        deleteLogiList={deleteLogiList} deleteMeal={deleteMeal} deleteMeteo={deleteMeteo} deletePhoto={deletePhoto} deleteResto={deleteResto} deleteShoppingItem={deleteShoppingItem}
        ...
        haptic={haptic} hebergement={hebergement} isCheckoutSoon={isCheckoutSoon} isDepartureDay={isDepartureDay} isOn={isOn} journal={journal}
        ...
        tab={tab} tabBarSwipe={tabBarSwipe} today={today} toggleBingo={toggleBingo} toggleCheck={toggleCheck} toggleDeparture={toggleDeparture}
        toggleFeature={toggleFeature} toggleSaved={toggleSaved} toggleShoppingItem={toggleShoppingItem} tr={tr} trajetDir={trajetDir} trajets={trajets}
        trip={trip} visibleTabs={visibleTabs} visitSort={visitSort} visits={visits}
      />
