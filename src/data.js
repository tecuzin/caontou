...
export const VISITS_INITIAL = [
  ...
  { id: 11, emoji: '🌋', name: 'Maison des Volcans, Aurillac', cat: 'Patrimoine', dist: '25 min', dur: '1 h 30', age: 'Des 3 ans', lat: 44.918, lng: 2.457, indoor: true },
  ...
  { id: 14, emoji: '🧀', name: 'Buronnerie & degustation Cantal', cat: 'Gourmand', dist: '30 min', dur: '1 h', age: 'Tous ages', lat: 45.046, lng: 2.732, indoor: true },
