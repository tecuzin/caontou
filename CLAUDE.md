...
- **Backend prévu** : Airtable (voir `AIRTABLE.md`, `ARCHITECTURE.md`).
...
- Porter le design haute-fidélité du prototype (`Cantou - Vacances Cantal.dc.html`)
  dans `src/` (5 onglets + sous-écrans, voir `README.md`).
- Brancher Airtable via un proxy serverless (clés API côté serveur).
